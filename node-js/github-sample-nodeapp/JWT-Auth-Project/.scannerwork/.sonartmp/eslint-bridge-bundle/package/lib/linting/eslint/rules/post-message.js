...
function hasVerifiedOrigin(context, listener, event) {
    ...
    const variable = scope === null || scope === void 0 ? void 0 : scope.variables.find(v => v.name === event.name);
    if (variable) {
        for (const reference of variable.references) {
            const identifier = reference.identifier;
            const parent = identifier.parent;
            if ((parent === null || parent === void 0 ? void 0 : parent.type) === 'MemberExpression' && ((_a = parent.parent) === null || _a === void 0 ? void 0 : _a.type) === 'BinaryExpression') {
                const { object, property } = parent;
                if (object === identifier && (0, helpers_1.isIdentifier)(property, 'origin')) {
                    return true;
                }
            }
        }
